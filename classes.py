...
class Fogtile(Sprite):
    def __init__(self, screen):
        super().__init__()
        self.screen = screen
        self.image = pg.image.load(find_data_file('img/40x40blacktile.bmp'))
...
class Player():
    def __init__(self, screen):
        self.screen = screen
        # self.image = pg.image.load(find_data_file('img/compass_01.gif'))
        # self.rect = self.image.get_rect()
        ...
        self.compass_imgs = ["img/comp/00.png", "img/comp/01.png", "img/comp/02.png", "img/comp/03.png", "img/comp/04.png", 
                     ...
                     "img/comp/15.png", "img/comp/16.png", "img/comp/17.png"]
        self.all_imgs = {}
...
class Floorplan():
    def __init__(self, screen):
        ...
        self.image = pg.image.load(find_data_file('img/campus_map.bmp'))
